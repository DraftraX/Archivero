                                            ...
                                            <div className="card disable-rounded-right mb-0 p-2">
                                                <div className="card-header pb-1">
                                                    <div className="card-title">
                                                        <h4 className="text-center mb-2">Nueva Contraseña</h4>
                                                    </div>
                                                </div>
                                                <div className="card-body">
                                                    <div className="text-muted text-center mb-2">
                                                        <small>Ingrese su nueva contraseña, recuerde que ambos campos deben ser iguales</small>
                                                    </div>
                                                    <form className="mb-2" onSubmit={handleSubmit}>
                                                        <input type="hidden" name="_token" value="ezJFlViWvl32MiTep9EMLUI5xP7q5fvHoHxd7ZSu" />
                                                        <div className="form-group mb-2">
                                                            <label className="text-bold-600" htmlFor="pass">Nueva Contraseña</label>
                                                            <input 
                                                                id="pass" 
                                                                type="password" 
                                                        ...
                                                        <div className="form-group mb-2">
                                                            <label className="text-bold-600" htmlFor="cpass">Confirmar Contraseña</label>
                                                            <input 
                                                                id="cpass" 
                                                                type="password" 
                                                                className="form-control" 
                                                        ...
                                                        <div className="text-center">
                                                            <button type="submit" className="btn btn-primary glow position-relative" style={{ fontSize: '0.95rem' }}>
                                                                Confirmar Cambios
                                                            </button>
                                                        </div>
                                                    </form>
