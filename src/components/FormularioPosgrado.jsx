...
const documentSchema = z.object({
  ...
  maestriadoctorado: z.string().nonempty("El grado de maestría o doctorado es obligatorio"),
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const response = await fetch(
        API_URL + "/posgrado/nuevoposgrado",
        {
          method: "POST",
          headers: {
          ...
          <div className="grid grid-flow-col-dense gap-4">
            ...
            <div>
              ...
              <Form.Item
                ...
                rules={[{ required: true, message: "Debe ingresar el grado de maestría o doctorado" }]}
              >
